module Hex.V4 exposing (fromString, toString)

{-| V4: Lookup table for toString (Array of 256 pre-computed hex pairs).
Encode unsignedInt32 (4 bytes at a time) for fromString.
-}
